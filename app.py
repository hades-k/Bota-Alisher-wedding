...
content = {
    "ru": {
        ...
        'no_kids': '👶 Пожалуйста, позаботьтесь об отдыхе ваших малышей - событие запланировано только для взрослых',
        ...
        'date': "11 октября 2025 года",
        'time': '17:00',
        'time_intro': '🕔 Время прибытия:',
        "rsvp_intro": "Подтвердите свое присутствие до 25 сентября",
    ...
    "kz": {
        ...
        'no_kids': '👶 Кішкентайларыңыздың тынығуына қамқорлық жасаңыз - бұл шара тек ересектерге арналған',
        ...
        'date': "2025 ж. 11 қазан",
        'time': 'сағат 17:00',
        'time_intro': '🕔 Келу уақыты:',
        "rsvp_intro": "Қатысуыңызды 25 қыркүйекке дейін растаңыз",
